  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#0f0f0f] via-black to-[#0a0a0a] flex items-center justify-center px-4 sm:px-6 py-12">
      <div className="w-full max-w-2xl text-center text-white animate-fade-in">
        ...
        <div className="mb-8">
          <a
            href="https://www.dropbox.com/scl/fi/73r7zkbk6872zl9v03eyy/Tonmoy-The-Zero-Dollar-YouTube-Blueprint-Sponsored-by-GroGrip.pdf?rlkey=o0y4zft94b3o8l8yyki0ztb00&st=n25atq6o&dl=0"
            target="_blank"
