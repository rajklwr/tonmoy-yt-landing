    ...
    >
      ...
      <div className="w-full max-w-6xl flex flex-col lg:flex-row justify-between lg:items-start space-y-12 lg:space-y-0 lg:space-x-16 p-4">
        ...
        <div className="flex-1 lg:flex-[0.35] w-full text-white sm:space-y-32 sm:mt-[500px] ">
          ...
          >
            <p>
              From this calendar, you can choose your convenient time to
              schedule a Zoom call.
            </p>{" "}
            <br />
            <p>
              Feel free to let us know, and we&apos;ll make sure to accommodate
              your schedule. 💪
            </p>{" "}
            <br />
            <p>
              Once you book the call, send me a message on any of my social
              platforms and I&apos;ll confirm the call from my end.
            </p>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex space-x-6">
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/profile.php?id=61559145152033"
                  target="_blank"
                  rel="noopener noreferrer"
                >
